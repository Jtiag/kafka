...
public class JavaKafkaLowerLevelConsumerTest {
    ...
    public static void test1() throws InterruptedException {
        ...
        brokers.add(new KafkaBrokerInfo("hadoop-senior02.ibeifeng.com", 9092));
        brokers.add(new KafkaBrokerInfo("hadoop-senior02.ibeifeng.com", 9093));
        brokers.add(new KafkaBrokerInfo("hadoop-senior02.ibeifeng.com", 9094));
        brokers.add(new KafkaBrokerInfo("hadoop-senior02.ibeifeng.com", 9095));
